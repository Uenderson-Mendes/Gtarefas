    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Aberta', 'Aberta'), ('Pendente', 'Pendente'), ('Executada', 'Executada')], default='Aberta', max_length=9)),
                ('datadoregistro', models.DateField(auto_now_add=True)),
